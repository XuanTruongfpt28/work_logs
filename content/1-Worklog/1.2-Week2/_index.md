...
### Week 2 Objectives:
- Understand the role of AWS Identity and Access Management (IAM) in managing users and permissions.
- Learn the core components of IAM, including Users, Groups, Roles, and Policies. 
...
Learned the functions of the main IAM components, including: 
  - IAM Users 
  - IAM Groups 
  - IAM Roles 
  - IAM Policies 

- Gained an understanding of the Principle of Least Privilege and how it helps improve the security of AWS environments. - 
...
- Assigned permissions to Users and Groups using IAM Policies and verified the access permissions for different accounts. 
- Learned how Multi-Factor Authentication (MFA) enhances account security and practiced enabling MFA for an AWS account. 
- Understood the purpose of Access Keys and learned how they are used securely when working with AWS CLI. 
- Became familiar with managing user identities and access permissions using IAM through both the AWS Management Console and the AWS CLI.
- Completed all hands-on labs and learning activities for Week 2, providing a solid foundation for the networking and infrastructure topics in the following weeks.
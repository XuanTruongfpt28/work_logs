...
### Week 6 Objectives:
- Learn the fundamentals of Elastic Load Balancing (ELB) on AWS. 
- Understand the role of Amazon EC2 Auto Scaling in improving application availability and scalability. 
- Practice deploying an Application Load Balancer and an Auto Scaling Group. 
...
- Learned the main components of Elastic Load Balancing, including:
  - Application Load Balancer (ALB) 
  - Target Group 
  - Listener 
  - Health Check 
- Successfully deployed an Application Load Balancer and configured a Target Group for multiple EC2 instances. 
- Understood how Health Checks work and learned how to monitor the health status of EC2 instances behind the Load Balancer. 
- Learned the fundamentals of Amazon EC2 Auto Scaling and its role in automatically adjusting the number of EC2 instances based on application demand. 
- Successfully created and configured: 
  - Launch Template 
  - Auto Scaling Group 
  - Scaling Policy 
  - Observed Scale Out and Scale In events by simulating workload changes, gaining a better understanding of how AWS maintains application performance and high availability. 
- Completed all hands-on labs related to Elastic Load Balancing and Auto Scaling as part of the Cloud Journey learning path. 
- Built a solid foundation for designing highly available, scalable, and fault-tolerant applications on AWS.
...
- Learn the fundamentals of Amazon Relational Database Service (Amazon RDS). 
- Understand the benefits of managed database services on AWS. 
- Practice creating and managing Amazon RDS instances. 
...
- Learned the basic concepts of Amazon RDS, including: 
  ...
  - Automated Backups 
  - Snapshots 
- Gained an understanding of the database engines supported by Amazon RDS, such as: 
  - MySQL 
  - PostgreSQL 
  -  MariaDB 
  - Microsoft SQL Server 
  - Oracle Database 
- Successfully launched an Amazon RDS instance and configured the required networking and security settings. 
- Connected to the RDS database using a database client and verified that the database service was functioning correctly. 
- Learned how to configure automated backups and create database snapshots for recovery purposes. 
- Became familiar with monitoring database performance and health using Amazon CloudWatch. 
- Completed all Amazon RDS hands-on labs and gained practical experience in deploying and managing relational databases on AWS. 
- Built a solid foundation for integrating databases into cloud applications and preparing for more advanced AWS architecture in the following weeks.
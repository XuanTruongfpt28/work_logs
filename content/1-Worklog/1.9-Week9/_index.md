...
### Week 9 Objectives:
- Learn the fundamentals of Amazon CloudWatch and AWS CloudTrail. 
- Understand how to monitor AWS resources and collect system logs. 
...
- Learned the main features of Amazon CloudWatch, including: 
  - Metrics 
  - Logs 
  - Dashboards 
  - Alarms 
- Successfully monitored Amazon EC2 resources using CloudWatch Metrics and created dashboards to visualize system performance. 
- Configured CloudWatch Alarms to monitor resource utilization and received notifications through Amazon SNS when predefined thresholds were exceeded.
- Learned the purpose of AWS CloudTrail and how it records API calls and user activities across AWS services. 
- Reviewed CloudTrail event history to understand how user actions and account activities can be tracked for auditing and security purposes. 
- Gained practical experience in monitoring application performance, identifying potential issues, and analyzing AWS account activities. 
- Completed all hands-on labs related to Amazon CloudWatch and AWS CloudTrail as part of the Cloud Journey learning path. 
- Built a stronger foundation in AWS monitoring, logging, and security practices, preparing for more advanced cloud operations and architecture topics.
...
- Understand the purpose of Amazon Elastic Container Registry (Amazon ECR) and Amazon Elastic Container Service (Amazon ECS). 
...
- Learned the fundamental components of Docker, including: 
  - Docker Images 
  - Docker Containers 
  - Dockerfiles 
  - Docker Hub 
- Successfully built Docker Images and ran containerized applications in a local environment. 
- Learned how to create and manage private container repositories using Amazon Elastic Container Registry (Amazon ECR).
- Successfully pushed Docker Images to Amazon ECR for cloud-based storage and management. 
- Understood the architecture and workflow of Amazon Elastic Container Service (Amazon ECS), including: 
  - ECS Cluster 
  - Task Definition 
  - Service 
- Successfully deployed a containerized application on Amazon ECS and verified that the service was running correctly. 
- Gained hands-on experience monitoring container deployments and resolving common deployment issues. 
- Completed all hands-on labs related to Docker, Amazon ECR, and Amazon ECS as part of the Cloud Journey learning path. 
- Built a solid foundation for deploying scalable containerized applications and preparing for modern cloud-native application development.